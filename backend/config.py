...
TIKTOK_LINK_RESOLVE_TIMEOUT_SECONDS = 10
TIKTOK_LINK_RESOLVE_ATTEMPTS = 3
TIKTOK_LINK_MAX_REDIRECTS = 3
TIKTOK_LINK_RESOLVE_RETRY_DELAY_SECONDS = 0.25
...
CUT_MIN_SCORE = float(os.getenv("CUT_MIN_SCORE", "0.10"))
