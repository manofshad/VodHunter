...
class PostgresDatabase:
    ...
    def __init__(
        ...
        *,
        ...
        if self.hnsw_iterative_scan not in {"off", "strict_order", "relaxed_order"}:
            raise ValueError(
                "hnsw_iterative_scan must be one of: off, strict_order, relaxed_order"
            )
        ...
        if (
            ...
            raise ValueError("hnsw_scan_mem_multiplier must be a finite number > 0")
